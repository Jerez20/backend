#"""Total de ventas a contado por rango de fecha
#SELECT  SUM(isnull(GRAVA,0)) GRAVADO, SUM(isnull(NOGRAVA,0)) NOGRABADO, SUM(isnull(ITBIS,0)) ITBIS, SUM(isnull(PROPINA,0)) PROPINA,SUM(isnull(MONTO,0)) TOTAL  FROM TRANSA01 WHERE FECHA BETWEEN '20231218' AND '20231229' AND TIPO ='03'
